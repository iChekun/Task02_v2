...
public class TripSpecificationByTypeOfFood extends AbstractTripSpecification {

        private Criteria criteria = new Criteria();
        private InputLineValidator validator;

        public TripSpecificationByTypeOfFood(String typeOfFood) {
            this.criteria.add(TripField.Trip.TYPE_OF_FOOD.toString(), typeOfFood);
